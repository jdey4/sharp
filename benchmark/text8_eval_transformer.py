...
parser.add_argument("--total_models", type=int, default=9)
...
for model_no in range(1, args.total_models + 1):
    ...
    ckpt_path = os.path.join(
        args.model_dir,
        f"transformer_{args.model_size}_model{model_no}_text8.pt",
    )
...
output_pickle = f"../pickle_files/text8_transformer_{args.model_size}_res.pickle"
